...
import gradio as gr
from rag_app.chains.basic_qa_chain import qa
...
if __name__ == "__main__":
    ...
    def infer(question, history):
        ...
        result = qa.invoke({"query": question, "history": history, "question": question})
        return result
    ...
    demo.queue().launch(share=False, debug=True, server_port=7861)