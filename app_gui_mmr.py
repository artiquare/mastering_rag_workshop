...
import gradio as gr
from rag_app.chains.mmr_qa_chain import qm
...
if __name__ == "__main__":
    ...
    def infer(question, history):
        ...
        result = qm({"query": question, "history": history, "question": question})
        return result
    ...
    demo.queue().launch(share=False, debug=True, server_port=7862)